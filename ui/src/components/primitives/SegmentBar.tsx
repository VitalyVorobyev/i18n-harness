// SegmentBar — multi-segment progress bar for finished / proposed / remainder.
// Used in locale stat displays throughout the app (project sidebar, focus view,
// overview). Each segment maps to a translation state.
