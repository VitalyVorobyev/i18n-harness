...
impl TranslationOutcome {
    ...
    /// flags. Convenience for tests and trivial backends.
    ...
    /// Construct a successful plural outcome with no model-supplied flags.
...
mod tests {
    ...
    #[test]
    fn translated_singular_helper_has_no_flags() {
    ...
    #[test]
    fn failed_outcome_carries_retryable_flag() {
