...
Undo history is currently limited to the active session and is not persisted to disk. Restarting the application clears all undo steps. This will be addressed in a future release.</source>
        ...
        <translation type="unfinished">Version 2.0 führt eine neu gestaltete Übersetzungstabelle ein, die Projekte mit Hunderten von Sprachvarianten in weniger als einer Sekunde lädt. Spalten sind jetzt nach Abschlussrate sortierbar, und die aktive Zelle scrollt automatisch in den sichtbaren Bereich.

Der Absturz, der beim Wechsel der Sprachvarianten während einer Hintergrundübersetzung auftrat, wurde behoben. Der Fortschrittszustand wird jetzt gespeichert, bevor der Sprachwechsel abgeschlossen ist.

Die Verlaufshistorie kann derzeit nur für die aktive Sitzung und wird nicht auf die Festplatte gespeichert. Das Neustarten der Anwendung löscht alle Rückgängig-Schritte. Dies wird in einem zukünftigen Release behoben.</translation>
    </message>
</context>
<context>
